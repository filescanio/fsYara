rule MAL_ELF_Bioset_Jul_2021_1 : hardened
{
	meta:
	...
	strings:
		$s1 = {65 78 65 63 20 62 61 73 68 20 2d 2d 6c 6f 67 69 6e}
		...
		$s3 = {61 6d 63 73 68 5f 63 6f 6e 6e 65 63 74}
		$s4 = {47 4f 54 20 48 41 48 41 3a 20 25 64}
