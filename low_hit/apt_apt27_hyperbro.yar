...
rule HvS_APT27_HyperBro_Stage3 : hardened
{
	meta:
	...
	strings:
		...
		$s2 = {76 00 66 00 74 00 72 00 61 00 63 00 65 00 2e 00 64 00 6c 00 6c 00}
		$s3 = {6d 00 73 00 6d 00 70 00 65 00 6e 00 67 00 2e 00 65 00 78 00 65 00}
		$s4 = {5c 00 5c 00 2e 00 5c 00 70 00 69 00 70 00 65 00 5c 00 74 00 65 00 73 00 74 00 70 00 69 00 70 00 65 00}
		$s5 = {74 00 68 00 75 00 6d 00 62 00 2e 00 64 00 61 00 74 00}
		$g1 = {25 00 73 00 5c 00 25 00 64 00 2e 00 65 00 78 00 65 00}
		$g2 = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 25 00 73 00 3a 00 25 00 64 00 2f 00 61 00 70 00 69 00 2f 00 76 00 32 00 2f 00 61 00 6a 00 61 00 78 00}
		$g3 = {20 00 2d 00 6b 00 20 00 6e 00 65 00 74 00 77 00 6f 00 72 00 6b 00 73 00 65 00 72 00 76 00 69 00 63 00 65 00}
		$g4 = {20 00 2d 00 6b 00 20 00 6c 00 6f 00 63 00 61 00 6c 00 73 00 65 00 72 00 76 00 69 00 63 00 65 00}
