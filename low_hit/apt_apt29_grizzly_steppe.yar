rule GRIZZLY_STEPPE_Malware_1 : hardened
{
	meta:
	...
	strings:
		$s1 = {53 3a 5c 4c 69 64 73 74 6f 6e 65 5c 72 65 6e 65 77 69 6e 67 5c 48 41 5c 64 69 73 61 62 6c 65 5c 49 6e 2e 70 64 62}
		$s2 = {52 00 65 00 70 00 65 00 61 00 74 00 20 00 6c 00 61 00 73 00 74 00 20 00 66 00 69 00 6e 00 64 00 20 00 63 00 6f 00 6d 00 6d 00 61 00 6e 00 64 00 29 00 52 00 65 00 70 00 6c 00 61 00 63 00 65 00 20 00 73 00 70 00 65 00 63 00 69 00 66 00 69 00 63 00 20 00 74 00 65 00 78 00 74 00 20 00 77 00 69 00 74 00 68 00 20 00 64 00 69 00 66 00 66 00 65 00 72 00 65 00 6e 00 74 00 20 00 74 00 65 00 78 00 74 00}
		$s3 = {6c 00 5c 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 6f 00 72 00 28 00 30 00 29 00 5c 00 25 00 20 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 6f 00 72 00 20 00 54 00 69 00 6d 00 65 00}
		$s6 = {53 00 65 00 6c 00 66 00 20 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00}
		$s7 = {44 00 65 00 66 00 61 00 75 00 6c 00 74 00 20 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00}
		$s8 = {53 00 74 00 61 00 72 00 20 00 50 00 6f 00 6c 00 6b 00 2e 00 65 00 78 00 65 00}

	condition:
		( uint16( 0 ) == 0x5a4d and filesize < 300KB and 4 of them )
}

rule GRIZZLY_STEPPE_Malware_2 : hardened
{
	meta:
	...
	strings:
		$x1 = {47 6f 6f 67 6c 65 43 72 61 73 68 52 65 70 6f 72 74 2e 64 6c 6c}
		$s1 = {43 72 61 73 68 45 72 72 6f 72 73}
		$s2 = {43 72 61 73 68 53 65 6e 64}
		$s3 = {43 72 61 73 68 41 64 64 44 61 74 61}
		$s4 = {43 72 61 73 68 43 6c 65 61 6e 75 70}
		$s5 = {43 72 61 73 68 49 6e 69 74}
