rule APT_APT41_POISONPLUG_3 : hardened
{
	meta:
	...
	strings:
		$s1 = {52 75 6e 64 6c 6c 33 32 2e 65 78 65 20 22 25 73 22 2c 20 44 69 73 50 6c 61 79 20 36 34}
		$s2 = {74 63 70 76 69 65 77 2e 65 78 65}
		$s3 = {6e 75 52 5c 6e 6f 69 73 72 65 56 74 6e 65 72 72 75 43 5c 73 77 6f 64 6e 69 57 5c 74 66 6f 73 6f 72 63 69 4d 5c 65 72 61 77 74 66 6f 53}
		$s4 = {41 78 45 65 75 6c 61 56 74 65 53 67 65 52}
		$s5 = {25 30 34 64 2d 25 30 32 64 2d 25 30 32 64 5f 25 30 32 64 2d 25 30 32 64 2d 25 30 32 64 2e 64 6d 70}
...
rule APT_APT41_CRACKSHOT : hardened
{
	meta:
	...
	strings:
		...
		$s1 = {52 75 6e 55 72 6c 42 69 6e 49 6e 4d 65 6d}
		$s2 = {44 6f 77 6e 52 75 6e 55 72 6c 46 69 6c 65}
		$s3 = {4d 6f 7a 69 6c 6c 61 2f 35 2e 30 20 28 57 69 6e 64 6f 77 73 20 4e 54 20 36 2e 31 3b 20 57 4f 57 36 34 29 20 41 70 70 6c 65 57 65 62 4b 69 74 2f 35 33 37 2e 33 36 20 28 4b 48 54 4d 4c 2c 20 6c 69 6b 65 20 47 65 63 6b 6f 29 20 43 68 72 6f 6d 65 2f 35 34 2e 30 2e 32 38 34 30 2e 37 31 20 53 61 66 61 72 69 2f 35 33 37 2e 33 36}
		$s4 = {25 73 7c 25 73 7c 25 73 7c 25 73 7c 25 73 7c 25 73 7c 25 73 7c 25 64 78 25 64 7c 25 30 34 78 7c 25 30 38 58 7c 25 73 7c 25 73}

	condition:
		uint16( 0 ) == 0x5a4d and filesize < 250KB and ( 1 of ( $x* ) or 2 of them )
}

rule APT_APT41_POISONPLUG_2 : hardened
{
	meta:
		description = "Detects APT41 malware POISONPLUG"
		author = "Florian Roth (Nextron Systems)"
	...
	strings:
		$s1 = {6d 00 61 00 5f 00 6c 00 6f 00 63 00 6b 00 64 00 6f 00 77 00 6e 00 5f 00 73 00 65 00 72 00 76 00 69 00 63 00 65 00 2e 00 64 00 6c 00 6c 00}
		$s2 = {61 63 62 64 65 2e 64 6c 6c}
		$s3 = {4d 00 41 00 20 00 6c 00 6f 00 63 00 6b 00 64 00 6f 00 77 00 6e 00 20 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00}
		$s4 = {4d 00 63 00 41 00 66 00 65 00 65 00 20 00 41 00 67 00 65 00 6e 00 74 00}
...
rule APT_APT41_POISONPLUG : hardened
{
	meta:
		description = "Detects APT41 malware POISONPLUG"
		author = "Florian Roth (Nextron Systems)"
	...
	strings:
		$s1 = {54 00 53 00 4d 00 53 00 49 00 53 00 72 00 76 00 2e 00 44 00 4c 00 4c 00}
		$s2 = {5b 2d 5d 77 72 69 74 65 20 66 61 69 6c 65 64 5b 25 64 5d}
		$s3 = {5b 2d 5d 6c 6f 61 64 20 66 61 69 6c 65 64}
		$s4 = {52 00 65 00 6d 00 6f 00 74 00 65 00 20 00 44 00 65 00 73 00 6b 00 74 00 6f 00 70 00 20 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 73 00}

	condition:
		uint16( 0 ) == 0x5a4d and filesize < 10000KB and ( pe.imphash ( ) == "1b074ef7a1c0888ef31337c8ad2f2e0a" or 2 of them )
}

rule APT_APT41_HIGHNOON : hardened
{
	meta:
	...
	strings:
		$x1 = {77 6f 72 6b 64 6c 6c 36 34 2e 64 6c 6c}
		$s1 = {5c 46 6f 6e 74 73 5c 45 72 72 6f 72 2e 6c 6f 67}
		$s2 = {5b 25 64 2f 25 64 2f 25 64 2f 25 64 3a 25 64 3a 25 64 5d}
		$s3 = {77 6f 72 6b 5f 65 6e 64}
		$s4 = {77 6f 72 6b 5f 73 74 61 72 74}
		$s5 = {5c 73 76 63 68 6f 73 74 2e 65 78 65}
		$s6 = {4c 6f 61 64 41 70 70 49 6e 69 74 5f 44 4c 4c 73}
		$s7 = {6e 65 74 73 76 63 73}
		$s8 = {48 6f 6f 6b 41 50 49 73 20 2e 2e 2e 50 49 44 20 25 64 20}
		$s9 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 48 54 4d 4c 48 65 6c 70}
		$s0 = {44 6c 6c 4d 61 69 6e 5f 6d 65 6d}
		$s10 = {25 73 5c 4e 74 4b 6c 52 65 73 2e 64 61 74}
		$s11 = {47 6c 6f 62 61 6c 5c 25 73 2d 25 64}
...
rule APT_APT41_HIGHNOON_2 : hardened
{
	meta:
		description = "Detects APT41 malware HIGHNOON"
		author = "Florian Roth (Nextron Systems)"
	...
	strings:
		...
		$s1 = {50 6c 75 73 44 6c 6c 2e 64 6c 6c}
		$s2 = {53 68 75 74 44 6f 77 6e 45 76 65 6e 74 2e 64 6c 6c}
...
rule APT_APT41_HIGHNOON_BIN : hardened
{
	meta:
	...
	strings:
		...
		$s3 = {25 73 25 73 5c 53 65 63 75 72 69 74 79}
		$s4 = {25 73 5c 53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 49 6e 74 65 72 6e 65 74 20 53 65 74 74 69 6e 67 73}
		$s5 = {25 73 25 73 5c 45 6e 75 6d}

	condition:
		uint16( 0 ) == 0x5a4d and filesize < 600KB and ( pe.imphash ( ) == "b70358b00dd0138566ac940d0da26a03" or 3 of them )
}

rule APT_APT41_HIGHNOON_BIN_2 : hardened
{
	meta:
		description = "Detects APT41 malware HIGHNOON.BIN"
		author = "Florian Roth (Nextron Systems)"
	...
	strings:
		...
		$x2 = {5b 53 74 6f 6e 65 5d 20 43 6f 6e 66 69 67 20 2d 2d 3e 20 32 6b 33 20 54 43 50 20 50 6f 73 69 74 69 76 65 20 4c 6f 67 6f 75 74 2e}
		$x3 = {5c 52 62 44 6f 6f 72 58 36 34 2e 70 64 62}
		$x4 = {52 00 62 00 44 00 6f 00 6f 00 72 00 2c 00 20 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 20 00 31 00 2e 00 30 00}
		$x5 = {41 00 62 00 6f 00 75 00 74 00 20 00 52 00 62 00 44 00 6f 00 6f 00 72 00}
...
rule APT_APT41_CN_ELF_Speculoos_Backdoor : hardened
{
	meta:
	...
	strings:
		...
		$s1 = {62 61 64 73 68 65 6c 6c}
		$s2 = {68 77 2e 70 68 79 73 6d 65 6d}
		$s3 = {75 6e 61 6d 65 20 2d 76}
		$s4 = {75 6e 61 6d 65 20 2d 73}
		$s5 = {6d 61 63 68 64 65 70 2e 74 73 63 5f 66 72 65 71}
		$s6 = {2f 75 73 72 2f 73 62 69 6e 2f 63 6f 6e 66 69 67 2e 62 61 6b}
		$s7 = {65 6e 74 65 72 20 4d 65 73 73 61 67 65 4c 6f 6f 70 2e 2e 2e}
		$s8 = {65 78 69 74 20 53 74 61 72 74 43 42 50 72 6f 63 65 73 73 2e 2e 2e}
