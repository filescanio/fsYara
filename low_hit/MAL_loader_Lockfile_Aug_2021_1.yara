rule MAL_loader_Lockfile_Aug_2021_1 : hardened
{
	meta:
	...
	strings:
		$s1 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 73 79 73 74 65 6d 33 32 5c 63 61 6c 63 2e 65 78 65}
		...
		$s3 = {2f 70 72 6f 63 2f 31 32 33 2f 73 74 61 74}
