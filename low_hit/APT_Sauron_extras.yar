...
rule Hacktool_This_Cruft : hardened
{
	meta:
	...
	strings:
		$x1 = {54 68 69 73 20 63 72 75 66 74}

	condition:
		( uint16( 0 ) == 0x5a4d and filesize < 200KB and $x1 )
}

rule APT_Project_Sauron_Custom_M1 : hardened
{
	meta:
	...
	strings:
		$s1 = {6e 00 63 00 6e 00 66 00 6c 00 6f 00 63 00 2e 00 64 00 6c 00 6c 00}
		$s4 = {4e 00 65 00 74 00 77 00 6f 00 72 00 6b 00 20 00 43 00 6f 00 6e 00 66 00 69 00 67 00 75 00 72 00 61 00 74 00 69 00 6f 00 6e 00 20 00 4c 00 6f 00 63 00 61 00 74 00 6f 00 72 00}
...
rule APT_Project_Sauron_Custom_M2 : hardened
{
	meta:
		description = "Detects malware from Project Sauron APT"
		author = "FLorian Roth"
...
rule APT_Project_Sauron_Custom_M3 : hardened
{
	meta:
		description = "Detects malware from Project Sauron APT"
		author = "FLorian Roth"
	...
	strings:
		$s1 = {45 78 61 6d 70 6c 65 50 72 6f 6a 65 63 74 2e 64 6c 6c}
...
rule APT_Project_Sauron_Custom_M4 : hardened
{
	meta:
		description = "Detects malware from Project Sauron APT"
		author = "FLorian Roth"
	...
	strings:
		$s1 = {78 00 70 00 73 00 6d 00 6e 00 67 00 72 00 2e 00 64 00 6c 00 6c 00}
		$s2 = {58 00 50 00 53 00 20 00 4d 00 61 00 6e 00 61 00 67 00 65 00 72 00}
...
rule APT_Project_Sauron_Custom_M6 : hardened
{
	meta:
		description = "Detects malware from Project Sauron APT"
		author = "FLorian Roth"
	...
	strings:
		$s1 = {72 00 73 00 65 00 63 00 65 00 6e 00 67 00 2e 00 64 00 6c 00 6c 00}
		$s2 = {52 00 65 00 6d 00 6f 00 74 00 65 00 20 00 53 00 65 00 63 00 75 00 72 00 69 00 74 00 79 00 20 00 45 00 6e 00 67 00 69 00 6e 00 65 00}
...
rule APT_Project_Sauron_Custom_M7 : hardened
{
	meta:
		description = "Detects malware from Project Sauron APT"
		author = "FLorian Roth"
	...
	strings:
		$sx1 = {44 00 65 00 66 00 61 00 75 00 6c 00 74 00 20 00 75 00 73 00 65 00 72 00}
		$sx2 = {48 69 6e 63 6f 72 72 65 63 74 20 68 65 61 64 65 72 20 63 68 65 63 6b}
		$sa1 = {4d 53 41 4f 53 53 50 43 2e 64 6c 6c}
		$sa2 = {4d 00 53 00 41 00 4f 00 53 00 53 00 50 00 43 00 2e 00 44 00 4c 00 4c 00}
		$sa3 = {4d 00 53 00 41 00 4f 00 53 00 53 00 50 00 43 00}
		$sa4 = {41 00 4f 00 4c 00 20 00 53 00 65 00 63 00 75 00 72 00 69 00 74 00 79 00 20 00 50 00 61 00 63 00 6b 00 61 00 67 00 65 00}
		$sa5 = {41 00 4f 00 4c 00 20 00 53 00 65 00 63 00 75 00 72 00 69 00 74 00 79 00 20 00 50 00 61 00 63 00 6b 00 61 00 67 00 65 00}
		$sa6 = {41 00 4f 00 4c 00 20 00 43 00 6c 00 69 00 65 00 6e 00 74 00 20 00 66 00 6f 00 72 00 20 00 33 00 32 00 20 00 62 00 69 00 74 00 20 00 70 00 6c 00 61 00 74 00 66 00 6f 00 72 00 6d 00 73 00}
