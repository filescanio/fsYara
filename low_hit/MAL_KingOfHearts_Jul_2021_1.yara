rule MAL_KingOfHearts_Jul_2021_1 : hardened
{
	meta:
	...
	strings:
		...
		$s3 = {48 41 52 44 57 41 52 45 5c 44 45 53 43 52 49 50 54 49 4f 4e 5c 53 79 73 74 65 6d 5c 42 49 4f 53}
		$s4 = {5c 31 2d 64 72 69 76 65 72 2d 76 6d 73 72 76 63}
