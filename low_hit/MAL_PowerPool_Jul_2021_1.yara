rule MAL_PowerPool_Jul_2021_1 : hardened
{
	meta:
	...
	strings:
		$s1 = {77 72 69 74 65 20 69 6e 66 6f 20 66 61 69 6c 21 21 21 20 47 65 74 4c 61 73 74 45 72 72 6f 72 2d 2d 3e 25 75}
		$s2 = {53 65 74 20 4f 70 74 69 6f 6e 20 66 61 69 6c 65 64 20 65 72 72 63 6f 64 65 3a 20 25 6c 64}
