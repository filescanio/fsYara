rule apt_RU_MoonlightMaze_customlokitools : hardened
{
	meta:
	...
	strings:
		...
		$a11 = {6f 72 6b 20 65 72 72 6f 72}

	condition:
		filesize < 5000KB and 3 of ( $a* )
}

rule apt_RU_MoonlightMaze_customsniffer : hardened
{
	meta:
		author = "Kaspersky Lab"
		date = "2017-03-15"
	...
	strings:
		$a1 = {2f 76 61 72 2f 74 6d 70 2f 67 6f 67 6f}
		$a2 = {6d 79 66 69 6c 65 6e 61 6d 65 3d 20 7c 25 73 7c}
		$a3 = {6d 79 70 69 64 2c 6d 79 67 69 64 3d}
		$a4 = {6d 79 70 69 64 3d 7c 25 64 7c 20 6d 79 67 69 64 3d 7c 25 64 7c}
		$a5 = {2f 76 61 72 2f 74 6d 70 2f 74 61 73 6b}
		$a6 = {6d 79 64 65 76 6e 61 6d 65 3d 20 7c 25 73 7c}
...
rule apt_RU_MoonlightMaze_de_tool : hardened
{
	meta:
		author = "Kaspersky Lab"
		date = "2017-03-27"
	...
	strings:
		$a1 = {56 6e 75 6b 3a 20 25 64}
		$a2 = {53 79 6e 3a 20 25 64}
...
rule apt_RU_MoonlightMaze_xk_keylogger : hardened
{
	meta:
		author = "Kaspersky Lab"
		date = "2017-03-27"
	...
	strings:
		...
		$a3 = {2f 76 61 72 2f 74 6d 70 2f 74 61 73 6b}
		$a4 = {2f 76 61 72 2f 74 6d 70 2f 74 61 73 6b 68 6f 73 74}
		$a5 = {6d 79 20 68 6f 73 74 6e 61 6d 65 3a 20 25 73}
		$a6 = {2f 76 61 72 2f 74 6d 70 2f 74 61 73 6b 6c 6f 67}
		$a7 = {2f 76 61 72 2f 74 6d 70 2f 2e 58 74 6d 70 30 31}
		$a8 = {6d 79 66 69 6c 65 6e 61 6d 65 3d 2d 25 73 2d}
		$a9 = {2f 76 61 72 2f 74 6d 70 2f 74 61 73 6b 70 69 64}
		$a10 = {6d 79 70 69 64 3d 2d 25 64 2d}
		$a11 = {2f 76 61 72 2f 74 6d 70 2f 74 61 73 6b 67 69 64}
		$a12 = {6d 79 67 69 64 3d 2d 25 64 2d}
