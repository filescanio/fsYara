rule Ran_BabukLockers_Jan_2021_1 : hardened
{
	meta:
	...
	strings:
		...
		$s1 = {5c 00 65 00 63 00 64 00 68 00 5f 00 70 00 75 00 62 00 5f 00 6b 00 2e 00 62 00 69 00 6e 00}
		$s2 = {6e 00 74 00 75 00 73 00 65 00 72 00 2e 00 64 00 61 00 74 00 2e 00 6c 00 6f 00 67 00}
		$s3 = {63 6d 64 2e 65 78 65}
		$s4 = {2f 00 63 00 20 00 76 00 73 00 73 00 61 00 64 00 6d 00 69 00 6e 00 2e 00 65 00 78 00 65 00 20 00 64 00 65 00 6c 00 65 00 74 00 65 00 20 00 73 00 68 00 61 00 64 00 6f 00 77 00 73 00 20 00 2f 00 61 00 6c 00 6c 00 20 00 2f 00 71 00 75 00 69 00 65 00 74 00}
