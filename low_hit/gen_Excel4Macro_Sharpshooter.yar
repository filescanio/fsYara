rule MAL_Sharpshooter_Excel4 : hardened
{
	meta:
	...
	strings:
		...
		$f1 = {43 72 65 61 74 65 54 68 72 65 61 64}
		$f2 = {57 72 69 74 65 50 72 6f 63 65 73 73 4d 65 6d 6f 72 79}
		$f3 = {4b 65 72 6e 65 6c 33 32}
...
rule SUSP_Excel4Macro_AutoOpen : hardened
{
	meta:
