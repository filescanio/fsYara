rule MAL_QueenOfHearts_Jul_2021_1 : hardened
{
	meta:
	...
	strings:
		$s1 = {73 65 6e 64 20 72 65 71 75 65 73 74 20 65 72 72 6f 72 3a 25 64}
		$s2 = {63 00 6f 00 6f 00 6b 00 69 00 65 00 20 00 73 00 69 00 7a 00 65 00 20 00 3a 00 25 00 64 00}
		$s3 = {71 00 75 00 65 00 72 00 79 00 63 00 6f 00 64 00 65 00 20 00 65 00 72 00 72 00 6f 00 72 00}
		...
		$s5 = {50 00 6d 00 4d 00 79 00 74 00 65 00 78 00 25 00 64 00}
