rule WinPayloads_PowerShell : hardened limited
{
	...
	strings:
		...
		$x2 = {70 6f 77 65 72 73 68 65 6c 6c 20 2d 77 20 68 69 64 64 65 6e 20 2d 6e 6f 6e 69 20 2d 65 6e 63 20 53 51 42 46}
...
rule WinPayloads_Payload : hardened
{
	meta:
	...
	strings:
		$s1 = {62 70 61 79 6c 6f 61 64 2e 65 78 65 2e 6d 61 6e 69 66 65 73 74}
		$s2 = {73 70 61 79 6c 6f 61 64}
