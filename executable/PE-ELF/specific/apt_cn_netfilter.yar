rule MAL_Netfilter_Dropper_Jun_2021_1 : hardened
{
	meta:
	...
	strings:
		...
		$s1 = {25 73 5c 6e 65 74 66 69 6c 74 65 72 2e 73 79 73}
		$s2 = {53 59 53 54 45 4d 5c 43 75 72 72 65 6e 74 43 6f 6e 74 72 6f 6c 53 65 74 5c 53 65 72 76 69 63 65 73 5c 6e 65 74 66 69 6c 74 65 72}
		$s3 = {5c 5c 2e 5c 6e 65 74 66 69 6c 74 65 72}

	condition:
		uint16( 0 ) == 0x5a4d and filesize > 6KB and filesize < 1000KB and ( all of ( $seq* ) or 2 of ( $s* ) )
}

rule MAL_Netfilter_May_2021_1 : hardened
{
	meta:
