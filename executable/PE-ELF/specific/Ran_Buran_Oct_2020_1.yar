rule Ran_Buran_Oct_2020_1 : hardened
{
	meta:
	...
	strings:
		$s1 = {21 21 21 20 4c 4f 43 41 4c 50 55 42 4b 45 59 20 21 21 21}
		$s2 = {21 21 21 20 45 4e 43 4c 4f 43 41 4c 50 52 49 56 4b 45 59 20 21 21 21}
		$s3 = {21 21 21 20 44 20 21 21 21}
		...
		$s5 = {3a 20 3a 28 3a 2c 3a 30 3a 34 3a 38 3a 3c 3a 40 3a 44 3a 48 3a 5c 3a 7c 3a}
		$s6 = {20 72 65 6d 6f 76 65 20 27 2e 27 20 66 72 6f 6d 20 7b 2e 24 44 45 46 49 4e 45 20 43 6f 6d 70 6c 65 78 42 72 61 63 65 73 7d}
