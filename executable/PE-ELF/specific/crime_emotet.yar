rule MAL_Emotet_JS_Dropper_Oct19_1 : hardened
{
	meta:
...
rule MAL_Emotet_Jan20_1 : hardened
{
	meta:
...
rule MAL_Emotet_BKA_Quarantine_Apr21 : hardened
{
	meta:
...
rule MAL_Emotet_BKA_Cleanup_Apr21 : hardened
{
	meta:
		author = "press inquiries <info@bka.de>, technical contact <info@mha.bka.de>"
		reference = "https://www.bka.de/DE/IhreSicherheit/RichtigesVerhalten/StraftatenImInternet/FAQ/FAQ_node.html"
...
rule EXT_MAL_SystemBC_Mar22_1 : hardened
{
	meta:
	...
	strings:
		$sx1 = {2d 57 69 6e 64 6f 77 53 74 79 6c 65 20 48 69 64 64 65 6e 20 2d 65 70 20 62 79 70 61 73 73 20 2d 66 69 6c 65}
		$sx2 = {42 45 47 49 4e 44 41 54 41}
		$sx3 = {47 45 54 20 25 73 20 48 54 54 50 2f 31 2e 30}
		$s5 = {55 73 65 72 2d 41 67 65 6e 74 3a}
		$s8 = {41 4c 4c 55 53 45 52 53 50 52 4f 46 49 4c 45}
