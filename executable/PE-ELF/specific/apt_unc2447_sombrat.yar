rule APT_UNC2447_MAL_SOMBRAT_May21_1 : hardened
{
	meta:
	...
	strings:
		$x1 = {7e 61 72 75 6e 67 76 63}
		$s1 = {70 6c 75 67 69 6e 36 34 5f}
		$s2 = {30 78 55 6e 6b 6e 6f 77 6e}
		$s3 = {62 25 78 2e 25 73}
		$s4 = {2f 6e 65 77 73}
...
rule APT_UNC2447_MAL_RANSOM_HelloKitty_May21_1 : hardened
{
	meta:
	...
	strings:
		...
		$s1 = {73 00 65 00 6c 00 65 00 63 00 74 00 20 00 2a 00 20 00 66 00 72 00 6f 00 6d 00 20 00 57 00 69 00 6e 00 33 00 32 00 5f 00 53 00 68 00 61 00 64 00 6f 00 77 00 43 00 6f 00 70 00 79 00}
		$s2 = {62 00 6f 00 6f 00 74 00 66 00 6f 00 6e 00 74 00 2e 00 62 00 69 00 6e 00}
		$s3 = {44 00 45 00 43 00 52 00 59 00 50 00 54 00 5f 00 4e 00 4f 00 54 00 45 00 2e 00 74 00 78 00 74 00}
...
rule APT_UNC2447_MAL_RANSOM_HelloKitty_May21_2 : hardened
{
	meta:
		description = "Detects HelloKitty Ransomware samples from UNC2447 campaign"
		author = "Florian Roth (Nextron Systems)"
	...
	strings:
		...
		$s2 = {25 00 73 00 5c 00 72 00 65 00 61 00 64 00 5f 00 6d 00 65 00 5f 00 6c 00 6b 00 64 00 2e 00 74 00 78 00 74 00}
		$s3 = {2f 00 43 00 20 00 70 00 69 00 6e 00 67 00 20 00 31 00 32 00 37 00 2e 00 30 00 2e 00 30 00 2e 00 31 00 20 00 26 00 20 00 64 00 65 00 6c 00 20 00 25 00 73 00}
		$s4 = {28 25 64 29 20 5b 25 64 5d 20 25 73 3a 20 53 54 4f 50 20 44 4f 55 42 4c 45 20 50 52 4f 43 45 53 53 20 52 55 4e}
...
rule APT_UNC2447_PS1_WARPRISM_May21_1 : hardened
{
	meta:
	...
	strings:
		$x1 = {69 66 20 28 24 4d 79 49 6e 76 6f 63 61 74 69 6f 6e 2e 4d 79 43 6f 6d 6d 61 6e 64 2e 50 61 74 68 20 2d 6d 61 74 63 68 20 27 5c 53 27 29 20 7b}
