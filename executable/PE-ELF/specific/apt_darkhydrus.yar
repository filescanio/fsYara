...
rule APT_DarkHydrus_Jul18_2 : hardened
{
	meta:
		description = "Detects strings found in malware samples in APT report in DarkHydrus"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
	...
	strings:
		$s4 = {77 69 6e 64 69 72}
		$s6 = {74 65 6d 70 2e 64 6c 6c}
		$s7 = {6c 69 62 67 63 6a 2d 31 32 2e 64 6c 6c}
		$s8 = {25 73 5c 53 79 73 74 65 6d 33 32 5c 25 73}
		$s9 = {53 74 61 72 74 57}
...
rule HKTL_Unlicensed_CobaltStrike_EICAR_Jul18_5 : hardened
{
	meta:
	...
	strings:
		...
		$s2 = {6c 69 62 67 63 6a 2d 31 32 2e 64 6c 6c}
