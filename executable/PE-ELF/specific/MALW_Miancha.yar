rule Trojan_W32_Gh0stMiancha_1_0_0 : hardened
{
	meta:
	...
	strings:
		...
		$2 = {44 6c 6c 43 61 6e 4c 6f 61 64 4e 6f 77}
		$2x = { 50 78 78 57 75 7a 58 7b 75 70 5a 7b 63 }
		$3x = { 5a 61 79 76 71 66 34 7b 72 34 67 61 76 7f 71 6d 67 2e 34 31 70 }
		$4 = {4a 58 4e 63 63 32 68 6c 62 47 78 63 62 33 42 6c 62 6c 78 6a 62 32 31 74 59 57 35 6b}
		$4x = { 5e 4c 5a 77 77 26 7c 78 76 53 6c 77 76 27 56 78 76 78 6c 7e 76 26 25 60 4d 43 21 7f }
		$5 = {53 45 46 53 52 46 64 42 55 6b 56 63 52 45 56 54 51 31 4a 4a 55 46 52 4a 54 30 35 63 55 33 6c 7a 64 47 56 74 58 45 4e 6c 62 6e 52 79 59 57 78 51 63 6d 39 6a 5a 58 4e 7a 62 33 4a 63 4d 41 3d 3d}
		...
		$6 = {43 3a 5c 55 73 65 72 73 5c 77 68 79 5c}
		$6x = { 57 2e 48 41 67 71 66 67 48 63 7c 6d 48 }
		$7 = {67 3a 5c 79 6b 63 78 5c}
		$7x = { 73 2E 48 6D 7F 77 6C 48 }
		$8 = {28 6d 69 61 6e 73 68 61 29}
		$8x = { 3C 79 7D 75 7A 67 7C 75 3D }
		$9 = {73 65 72 76 65 72 28 e5 a3 b3 29}
