...
rule IMPLANT_3_v1 : hardened
{
	...
	strings:
		$STR1 = {((3e 70 72 6f 63 65 73 73 20 69 73 6e 27 74 20 65 78 69 73 74 3c) | (3e 00 70 00 72 00 6f 00 63 00 65 00 73 00 73 00 20 00 69 00 73 00 6e 00 27 00 74 00 20 00 65 00 78 00 69 00 73 00 74 00 3c 00))}
		$STR2 = {((73 68 65 6c 6c 5c 6f 70 65 6e 5c 63 6f 6d 6d 61 6e 64 3d 22 53 79 73 74 65 6d 20 56 6f 6c 75 6d 65 20 49 6e 66 6f 72 6d 61 74 69 6f 6e 5c 55 53 42 47 75 61 72 64 2e 65 78 65 22 20 69 6e 73 74 61 6c 6c) | (73 00 68 00 65 00 6c 00 6c 00 5c 00 6f 00 70 00 65 00 6e 00 5c 00 63 00 6f 00 6d 00 6d 00 61 00 6e 00 64 00 3d 00 22 00 53 00 79 00 73 00 74 00 65 00 6d 00 20 00 56 00 6f 00 6c 00 75 00 6d 00 65 00 20 00 49 00 6e 00 66 00 6f 00 72 00 6d 00 61 00 74 00 69 00 6f 00 6e 00 5c 00 55 00 53 00 42 00 47 00 75 00 61 00 72 00 64 00 2e 00 65 00 78 00 65 00 22 00 20 00 69 00 6e 00 73 00 74 00 61 00 6c 00 6c 00))}
		$STR3 = {((55 73 65 72 2d 41 67 65 6e 74 3a 20 4d 6f 7a 69 6c 6c 61 2f 35 2e 30 20 28 57 69 6e 64 6f 77 73 20 4e 54 20 36 2e 3b 20 57 4f 57 36 34 3b 20 72 76 3a 32 30 2e 30 29 20 47 65 63 6b 6f 2f 32 30 31 30 30 31 30 31 20 46 69 72 65 66 6f 78 2f 32 30 2e 30) | (55 00 73 00 65 00 72 00 2d 00 41 00 67 00 65 00 6e 00 74 00 3a 00 20 00 4d 00 6f 00 7a 00 69 00 6c 00 6c 00 61 00 2f 00 35 00 2e 00 30 00 20 00 28 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 20 00 4e 00 54 00 20 00 36 00 2e 00 3b 00 20 00 57 00 4f 00 57 00 36 00 34 00 3b 00 20 00 72 00 76 00 3a 00 32 00 30 00 2e 00 30 00 29 00 20 00 47 00 65 00 63 00 6b 00 6f 00 2f 00 32 00 30 00 31 00 30 00 30 00 31 00 30 00 31 00 20 00 46 00 69 00 72 00 65 00 66 00 6f 00 78 00 2f 00 32 00 30 00 2e 00 30 00))}
		$STR4 = {((77 65 62 68 70 3f 72 65 6c 3d 70 73 79 26 68 6c 3d 37 26 61 69 3d) | (77 00 65 00 62 00 68 00 70 00 3f 00 72 00 65 00 6c 00 3d 00 70 00 73 00 79 00 26 00 68 00 6c 00 3d 00 37 00 26 00 61 00 69 00 3d 00))}
...
rule IMPLANT_3_v3 : hardened
{
	...
	strings:
		$STR1 = {2e 3f 41 56 41 67 65 6e 74 4b 65 72 6e 65 6c 40 40}
		$STR2 = {2e 3f 41 56 49 41 67 65 6e 74 4d 6f 64 75 6c 65 40 40}
		$STR3 = {41 67 65 6e 74 4b 65 72 6e 65 6c}

	condition:
		( uint16( 0 ) == 0x5A4D or uint16( 0 ) == 0xCFD0 or uint16( 0 ) == 0xC3D4 or uint32( 0 ) == 0x46445025 or uint32( 1 ) == 0x6674725C ) and any of them
}

rule IMPLANT_4_v1 : hardened
{
	meta:
...
rule IMPLANT_4_v3_AlternativeRule : hardened
{
	meta:
		description = "BlackEnergy / Voodoo Bear Implant by APT28"
...
rule IMPLANT_4_v4 : hardened
{
	...
	strings:
		$DK_format1 = {2f 63 20 66 6f 72 6d 61 74 20 25 63 3a 20 2f 59 20 2f 51}
		$DK_format2 = {2f 63 20 66 6f 72 6d 61 74 20 25 63 3a 20 2f 59 20 2f 58 20 2f 46 53 3a 4e 54 46 53}
		$DK_physicaldrive = {50 00 68 00 79 00 73 00 69 00 63 00 61 00 6c 00 44 00 72 00 69 00 76 00 65 00 25 00 64 00}
		$DK_shutdown = {73 68 75 74 64 6f 77 6e 20 2f 72 20 2f 74 20 25 64}

	condition:
		uint16( 0 ) == 0x5A4D and all of ( $DK* )
}

rule IMPLANT_4_v7 : hardened
{
	meta:
		description = "BlackEnergy / Voodoo Bear Implant by APT28"
		author = "US CERT"
...
rule IMPLANT_4_v9 : hardened limited
{
	meta:
		description = "BlackEnergy / Voodoo Bear Implant by APT28"
		author = "US CERT"
	...
	strings:
		$a = {((77 65 76 74 75 74 69 6c 20 63 6c 65 61 72 2d 6c 6f 67) | (77 00 65 00 76 00 74 00 75 00 74 00 69 00 6c 00 20 00 63 00 6c 00 65 00 61 00 72 00 2d 00 6c 00 6f 00 67 00))}
		$b = {((76 73 73 61 64 6d 69 6e 20 64 65 6c 65 74 65 20 73 68 61 64 6f 77 73) | (76 00 73 00 73 00 61 00 64 00 6d 00 69 00 6e 00 20 00 64 00 65 00 6c 00 65 00 74 00 65 00 20 00 73 00 68 00 61 00 64 00 6f 00 77 00 73 00))}
		$c = {((41 47 6c 6f 62 61 6c 5c 32 33 64 31 61 32 35 39 2d 38 38 66 61 2d 34 31 64 66 2d 39 33 35 66 2d 63 61 65 35 32 33 62 61 62 38 65 36) | (41 00 47 00 6c 00 6f 00 62 00 61 00 6c 00 5c 00 32 00 33 00 64 00 31 00 61 00 32 00 35 00 39 00 2d 00 38 00 38 00 66 00 61 00 2d 00 34 00 31 00 64 00 66 00 2d 00 39 00 33 00 35 00 66 00 2d 00 63 00 61 00 65 00 35 00 32 00 33 00 62 00 61 00 62 00 38 00 65 00 36 00))}
		$d = {((47 6c 6f 62 61 6c 5c 30 37 66 64 33 61 62 33 2d 30 37 32 34 2d 34 63 66 64 2d 38 63 63 32 2d 36 30 63 30 65 34 35 30 62 62 39 61) | (47 00 6c 00 6f 00 62 00 61 00 6c 00 5c 00 30 00 37 00 66 00 64 00 33 00 61 00 62 00 33 00 2d 00 30 00 37 00 32 00 34 00 2d 00 34 00 63 00 66 00 64 00 2d 00 38 00 63 00 63 00 32 00 2d 00 36 00 30 00 63 00 30 00 65 00 34 00 35 00 30 00 62 00 62 00 39 00 61 00))}
...
rule IMPLANT_4_v11 : hardened
{
	...
	strings:
		$ = {2f 63 20 66 6f 72 6d 61 74 20 25 63 3a 20 2f 59 20 2f 58 20 2f 46 53 3a 4e 54 46 53}
		$ = {2e 00 65 00 78 00 65 00 2e 00 73 00 79 00 73 00 2e 00 64 00 72 00 76 00 2e 00 64 00 6f 00 63 00 2e 00 64 00 6f 00 63 00 78 00 2e 00 78 00 6c 00 73 00 2e 00 78 00 6c 00 73 00 78 00 2e 00 6d 00 64 00 62 00 2e 00 70 00 70 00 74 00 2e 00 70 00 70 00 74 00 78 00 2e 00 78 00 6d 00 6c 00 2e 00 6a 00 70 00 67 00 2e 00 6a 00 70 00 65 00 67 00 2e 00 69 00 6e 00 69 00 2e 00 69 00 6e 00 66 00 2e 00 74 00 74 00 66 00}
		$ = {2e 00 64 00 6c 00 6c 00 2e 00 65 00 78 00 65 00 2e 00 78 00 6d 00 6c 00 2e 00 74 00 74 00 66 00 2e 00 6e 00 66 00 6f 00 2e 00 66 00 6f 00 6e 00 2e 00 69 00 6e 00 69 00 2e 00 63 00 66 00 67 00 2e 00 62 00 6f 00 6f 00 74 00 2e 00 6a 00 61 00 72 00}
		$ = {2e 00 63 00 72 00 74 00 2e 00 62 00 69 00 6e 00 2e 00 65 00 78 00 65 00 2e 00 64 00 62 00 2e 00 64 00 62 00 66 00 2e 00 70 00 64 00 66 00 2e 00 64 00 6a 00 76 00 75 00 2e 00 64 00 6f 00 63 00 2e 00 64 00 6f 00 63 00 78 00 2e 00 78 00 6c 00 73 00 2e 00 78 00 6c 00 73 00 78 00 2e 00 6a 00 61 00 72 00 2e 00 70 00 70 00 74 00 2e 00 70 00 70 00 74 00 78 00 2e 00 74 00 69 00 62 00 2e 00 76 00 68 00 64 00 2e 00 69 00 73 00 6f 00 2e 00 6c 00 69 00 62 00 2e 00 6d 00 64 00 62 00 2e 00 61 00 63 00 63 00 64 00 62 00 2e 00 73 00 71 00 6c 00 2e 00 6d 00 64 00 66 00 2e 00 78 00 6d 00 6c 00 2e 00 72 00 74 00 66 00 2e 00 69 00 6e 00 69 00 2e 00 63 00 66 00 20 00 67 00 2e 00 62 00 6f 00 6f 00 74 00 2e 00 74 00 78 00 74 00 2e 00 72 00 61 00 72 00 2e 00 6d 00 73 00 69 00 2e 00 7a 00 69 00 70 00 2e 00 6a 00 70 00 67 00 2e 00 62 00 6d 00 70 00 2e 00 6a 00 70 00 65 00 67 00 2e 00 74 00 69 00 66 00 66 00}
		$tempfilename = {((25 6c 73 5f 25 6c 73 5f 25 6c 73 5f 25 64 2e 7e 74 6d 70) | (25 00 6c 00 73 00 5f 00 25 00 6c 00 73 00 5f 00 25 00 6c 00 73 00 5f 00 25 00 64 00 2e 00 7e 00 74 00 6d 00 70 00))}

	condition:
		( uint16( 0 ) == 0x5A4D or uint16( 0 ) == 0xCFD0 or uint16( 0 ) == 0xC3D4 or uint32( 0 ) == 0x46445025 or uint32( 1 ) == 0x6674725C ) and 2 of them
}

rule IMPLANT_4_v13 : hardened
{
	meta:
		description = "BlackEnergy / Voodoo Bear Implant by APT28"
		author = "US CERT"
	...
	strings:
		...
		$XMLPARSE = {8B 06 [0-2] 8D 55 ?C 52 FF 75 08 [0-2] 50 FF 91 04 01 00 00
         ...
         78 2?}
		$EXP1 = {44 69 73 70 61 74 63 68 43 6f 6d 6d 61 6e 64}
		$EXP2 = {44 69 73 70 61 74 63 68 45 76 65 6e 74}
...
rule IMPLANT_5_v1 : hardened
{
	...
	strings:
		...
		$UDPMSG1 = {65 72 72 6f 72 20 32 30 30 35 20 72 65 63 76 20 66 72 6f 6d 20 73 65 72 76 65 72 20 55 44 50 20 2d 20 25 64 0a}
		$TPSMSG1 = {65 72 72 6f 72 20 32 30 30 34 20 73 65 6e 64 20 74 6f 20 54 50 53 20 2d 20 25 64 0a}
		$TPSMSG2 = {65 72 72 6f 72 20 32 30 30 33 20 72 65 63 76 20 66 72 6f 6d 20 54 50 53 20 2d 20 25 64 0a}
		$UDPMSG2 = {65 72 72 6f 72 20 32 30 30 32 20 73 65 6e 64 20 74 6f 20 73 65 72 76 65 72 20 55 44 50 20 2d 20 25 64 0a}

	condition:
		any of them
}

rule IMPLANT_5_v2 : hardened
{
	meta:
		description = "XTunnel Implant by APT28"
		author = "US CERT"
...
rule IMPLANT_6_v1 : hardened
{
	...
	strings:
		$STR1 = {((64 6c 6c 2e 64 6c 6c) | (64 00 6c 00 6c 00 2e 00 64 00 6c 00 6c 00))}
		$STR2 = {((49 6e 69 74 31) | (49 00 6e 00 69 00 74 00 31 00))}
		$STR3 = {((6e 65 74 75 69 2e 64 6c 6c) | (6e 00 65 00 74 00 75 00 69 00 2e 00 64 00 6c 00 6c 00))}

	condition:
		( uint16( 0 ) == 0x5A4D or uint16( 0 ) == 0xCFD0 or uint16( 0 ) == 0xC3D4 or uint32( 0 ) == 0x46445025 or uint32( 1 ) == 0x6674725C ) and all of them
}

rule IMPLANT_6_v2 : hardened
{
	meta:
		description = "Sednit / EVILTOSS Implant by APT28"
		author = "US CERT"
...
rule IMPLANT_8_v1 : hardened
{
	...
	strings:
		$DOTNET = {6d 73 63 6f 72 6c 69 62}
		$REF_URL = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 77 00 77 00 77 00 2e 00 67 00 6f 00 6f 00 67 00 6c 00 65 00 2e 00 63 00 6f 00 6d 00 2f 00 75 00 72 00 6c 00 3f 00 73 00 61 00 3d 00}
		$REF_var_1 = {26 00 72 00 63 00 74 00 3d 00}
		$REF_var_2 = {26 00 71 00 3d 00 26 00 65 00 73 00 72 00 63 00 3d 00}
		$REF_var_3 = {26 00 73 00 6f 00 75 00 72 00 63 00 65 00 3d 00}
		$REF_var_4 = {26 00 63 00 64 00 3d 00}
		$REF_var_5 = {26 00 76 00 65 00 64 00 3d 00}
		$REF_var_6 = {26 00 75 00 72 00 6c 00 3d 00}
		$REF_var_7 = {26 00 65 00 69 00 3d 00}
		$REF_var_8 = {26 00 75 00 73 00 67 00 3d 00}
		$REF_var_9 = {26 00 62 00 76 00 6d 00 3d 00}
		$REF_value_1 = {51 00 46 00 6a 00}
		$REF_value_2 = {62 00 76 00 2e 00 38 00 31 00}

	condition:
		( uint16( 0 ) == 0x5A4D ) and ( $DOTNET ) and ( $REF_URL ) and ( 3 of ( $REF_var* ) ) and ( 1 of ( $REF_value* ) )
}

rule IMPLANT_9_v1 : hardened
{
	meta:
...
rule Unidentified_Malware_Two : hardened
{
	meta:
	...
	strings:
		$my_string_one = {2f 7a 61 70 6f 79 2f 67 61 74 65 2e 70 68 70}
		...
		$my_string_three = {53 3a 5c 4c 69 64 73 74 6f 6e 65 5c 72 65 6e 65 77 69 6e 67 5c 48 41 5c 64 69 73 61 62 6c 65 5c 49 6e 2e 70 64 62}
		$my_string_four = { 8B CF 0F AF CE 8B C6 99 2B C2 8B 55 08 D1 F8 03 C8
         8B 45 FC 03 C2 89 45 10 8A 00 2B CB 32 C1 85 DB 74 07 }
		$my_string_five = {66 75 63 6b 79 6f 75 31}
		$my_string_six = {78 74 6f 6f 6c 2e 65 78 65}
