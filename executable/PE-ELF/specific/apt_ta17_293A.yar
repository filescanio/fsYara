...
rule TA17_293A_Hacktool_PS_1 : hardened
{
	meta:
	...
	strings:
		...
		$x2 = {7d 20 7c 20 57 68 65 72 65 2d 4f 62 6a 65 63 74 20 7b 24 5f 2e 53 61 6d 41 63 63 6f 75 6e 74 4e 61 6d 65 20 2d 6e 6f 74 6d 61 74 63 68 20 27 6b 72 62 74 67 74 27 7d 20 7c 20 47 65 74 2d 53 50 4e 54 69 63 6b 65 74 20 40 47 65 74 53 50 4e 54 69 63 6b 65 74 41 72 67 75 6d 65 6e 74 73}

	condition:
		( filesize < 80KB and 1 of them )
}

rule TA17_293A_Hacktool_Touch_MAC_modification : hardened
{
	meta:
		description = "Auto-generated rule"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
	...
	strings:
		$s1 = {2d 74 20 74 69 6d 65 20 2d 20 75 73 65 20 74 68 65 20 74 69 6d 65 20 73 70 65 63 69 66 69 65 64 20 74 6f 20 75 70 64 61 74 65 20 74 68 65 20 61 63 63 65 73 73 20 61 6e 64 20 6d 6f 64 69 66 69 63 61 74 69 6f 6e 20 74 69 6d 65 73}
		$s2 = {46 61 69 6c 65 64 20 74 6f 20 73 65 74 20 66 69 6c 65 20 74 69 6d 65 73 20 66 6f 72 20 25 73 2e 20 45 72 72 6f 72 3a 20 25 78}
		$s3 = {74 6f 75 63 68 20 5b 2d 61 63 6d 5d 5b 20 2d 72 20 72 65 66 5f 66 69 6c 65 20 7c 20 2d 74 20 74 69 6d 65 5d 20 66 69 6c 65 2e 2e 2e}
		$s4 = {2d 6d 20 2d 20 63 68 61 6e 67 65 20 74 68 65 20 6d 6f 64 69 66 69 63 61 74 69 6f 6e 20 74 69 6d 65 20 6f 6e 6c 79}

	condition:
		( uint16( 0 ) == 0x5a4d and filesize < 100KB and 1 of them )
}

rule TA17_293A_Hacktool_Exploit_MS16_032 : hardened
{
	meta:
		description = "Auto-generated rule"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
	...
	strings:
		...
		$x2 = {30 78 30 30 30 30 30 30 30 32 2c 20 22 43 3a 5c 57 69 6e 64 6f 77 73 5c 53 79 73 74 65 6d 33 32 5c 63 6d 64 2e 65 78 65 22 2c 20 22 22 2c}
		$x3 = {50 6f 77 65 72 53 68 65 6c 6c 20 69 6d 70 6c 65 6d 65 6e 74 61 74 69 6f 6e 20 6f 66 20 4d 53 31 36 2d 30 33 32 2e 20 54 68 65 20 65 78 70 6c 6f 69 74 20 74 61 72 67 65 74 73 20 61 6c 6c 20 76 75 6c 6e 65 72 61 62 6c 65}
		$x4 = {49 66 20 77 65 20 63 61 6e 27 74 20 6f 70 65 6e 20 74 68 65 20 70 72 6f 63 65 73 73 20 74 6f 6b 65 6e 20 69 74 27 73 20 61 20 53 59 53 54 45 4d 20 73 68 65 6c 6c 21}
