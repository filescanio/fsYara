rule Lokibot : hardened
{
	...
	strings:
		$des3 = { 68 03 66 00 00 }
		$param = {4d 41 43 3d 25 30 32 58 25 30 32 58 25 30 32 58 49 4e 53 54 41 4c 4c 3d 25 30 38 58 25 30 38 58}
