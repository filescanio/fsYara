rule CobaltStrike_C2_Host_Indicator : hardened
{
	meta:
	...
	strings:
		$c2_indicator_fp = {23 48 6f 73 74 3a 20 25 73}
		$c2_indicator = {23 48 6f 73 74 3a}

	condition:
		$c2_indicator and not $c2_indicator_fp and not uint32( 0 ) == 0x0a786564 and not uint32( 0 ) == 0x0a796564
}

rule CobaltStrike_Sleep_Decoder_Indicator : hardened
{
	meta:
...
rule CobaltStrike_C2_Encoded_XOR_Config_Indicator : hardened
{
	meta:
	...
	strings:
		...
		$fp1 = {49 00 43 00 53 00 68 00 61 00 72 00 70 00 43 00 6f 00 64 00 65 00 2e 00 44 00 65 00 63 00 6f 00 6d 00 70 00 69 00 6c 00 65 00 72 00}

	condition:
		any of ( $s* ) and not 1 of ( $fp* )
}

rule CobaltStrike_MZ_Launcher : hardened
{
	meta:
...
rule CobaltStrike_Unmodifed_Beacon : hardened
{
	meta:
	...
	strings:
		$loader_export = {52 65 66 6c 65 63 74 69 76 65 4c 6f 61 64 65 72}
		$exportname = {62 65 61 63 6f 6e 2e 64 6c 6c}
