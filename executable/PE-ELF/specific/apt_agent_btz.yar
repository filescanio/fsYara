...
rule Agent_BTZ_Proxy_DLL_1 : hardened
{
	meta:
	...
	strings:
		$s1 = {53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 43 00 75 00 72 00 72 00 65 00 6e 00 74 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 5c 00 45 00 78 00 70 00 6c 00 6f 00 72 00 65 00 72 00 5c 00 4d 00 6f 00 64 00 75 00 6c 00 65 00 73 00}
...
rule Agent_BTZ_Proxy_DLL_2 : hardened
{
	meta:
		description = "Detects Agent-BTZ Proxy DLL - activeds.dll"
		author = "Florian Roth (Nextron Systems)"
	...
	strings:
		...
		$s2 = {61 63 74 69 76 65 64 73 2e 64 6c 6c}
...
rule Agent_BTZ_Aug17 : hardened
{
	...
	strings:
		$s1 = {73 74 64 6f 6c 65 32 2e 74 6c 62}
		$s2 = {55 6e 49 6e 73 74 61 6c 6c 57}
...
rule APT_Turla_Agent_BTZ_Gen_1 : hardened
{
	meta:
	...
	strings:
		...
		$s1 = {72 65 6c 65 61 73 65 20 6d 75 74 65 78 20 2d 20 25 75 20 28 25 75 29 28 25 75 29}
		$s2 = {5c 73 79 73 74 65 6d 33 32 5c 77 69 6e 2e 63 6f 6d}
		$s3 = {43 6f 6d 6d 61 6e 64 20 49 64 3a 25 75 25 30 31 30 75 28 25 30 32 64 3a 25 30 32 64 3a 25 30 32 64 20 25 30 32 64 2f 25 30 32 64 2f 25 30 34 64 29}
		$s4 = {4d 61 6b 65 46 69 6c 65 20 45 72 72 6f 72 28 25 64 29 20 63 6f 70 79 20 66 69 6c 65 20 74 6f 20 74 65 6d 70 20 66 69 6c 65 20 25 73}
		$s5 = {25 73 25 25 73 30 38 78 2e 74 6d 70}
		$s6 = {52 75 6e 20 69 6e 73 74 72 75 63 74 69 6f 6e 3a 20 25 64 20 49 44 3a 25 75 25 30 31 30 75 28 25 30 32 64 3a 25 30 32 64 3a 25 30 32 64 20 25 30 32 64 2f 25 30 32 64 2f 25 30 34 64 29}
		$s7 = {4d 75 74 65 78 5f 4c 6f 67}
		$s8 = {25 73 5c 73 79 73 74 65 6d 33 32 5c 77 69 6e 76 69 65 77 2e 6f 63 78}
		$s9 = {4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 28 00 52 00 29 00 20 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 20 00 28 00 52 00 29 00 20 00 4f 00 70 00 65 00 72 00 61 00 74 00 69 00 6e 00 67 00 20 00 53 00 79 00 73 00 74 00 65 00 6d 00}
		$s10 = {45 72 72 6f 72 3a 20 70 6f 73 28 25 64 29 20 3e 20 43 6d 64 53 69 7a 65 28 25 64 29}
		$s11 = {5c 77 69 6e 2e 63 6f 6d}
		$s12 = {45 72 72 6f 72 28 25 64 29 20 72 75 6e 20 25 73 20}
		$s13 = {25 30 32 64 2e 25 30 32 64 2e 25 30 34 64 20 4c 6f 67 20 62 65 67 69 6e 3a}
