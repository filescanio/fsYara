rule Mimikatz_Memory_Rule_1 : APT hardened
{
	meta:
		author = "Florian Roth"
		date = "2014-12-22"
	...
	strings:
		$s1 = {73 65 6b 75 72 6c 73 61 3a 3a 77 64 69 67 65 73 74}
		$s2 = {73 65 6b 75 72 6c 73 61 3a 3a 6c 6f 67 6f 6e 50 61 73 73 77 6f 72 64 73}
		$s3 = {73 65 6b 75 72 6c 73 61 3a 3a 6d 69 6e 69 64 75 6d 70}
		$s4 = {73 65 6b 75 72 6c 73 61 3a 3a 63 72 65 64 6d 61 6e}
		$fp1 = {22 78 5f 6d 69 74 72 65 5f 76 65 72 73 69 6f 6e 22 3a 20}
		$fp2 = {7b 22 74 79 70 65 22 3a 22 62 75 6e 64 6c 65 22 2c}
		$fp3 = {75 73 65 20 73 74 72 69 63 74}
...
rule Mimikatz_Logfile : hardened
{
	meta:
	...
	strings:
		$s1 = {53 49 44 20 20 20 20 20 20 20 20 20 20 20 20 20 20 20 3a}
		$s2 = {2a 20 4e 54 4c 4d 20 20 20 20 20 3a}
		$s3 = {41 75 74 68 65 6e 74 69 63 61 74 69 6f 6e 20 49 64 20 3a}
		$s4 = {77 64 69 67 65 73 74 20 3a}
...
rule Mimikatz_Strings : hardened
{
	meta:
	...
	strings:
		...
		$x13 = {5b 00 6d 00 61 00 73 00 74 00 65 00 72 00 6b 00 65 00 79 00 5d 00 20 00 77 00 69 00 74 00 68 00 20 00 70 00 61 00 73 00 73 00 77 00 6f 00 72 00 64 00 3a 00 20 00 25 00 73 00 20 00 28 00 25 00 73 00 20 00 75 00 73 00 65 00 72 00 29 00}
		...
		$x15 = {2a 00 2a 00 20 00 53 00 65 00 73 00 73 00 69 00 6f 00 6e 00 20 00 6b 00 65 00 79 00 20 00 69 00 73 00 20 00 4e 00 55 00 4c 00 4c 00 21 00 20 00 49 00 74 00 20 00 6d 00 65 00 61 00 6e 00 73 00 20 00 61 00 6c 00 6c 00 6f 00 77 00 74 00 67 00 74 00 73 00 65 00 73 00 73 00 69 00 6f 00 6e 00 6b 00 65 00 79 00 20 00 69 00 73 00 20 00 6e 00 6f 00 74 00 20 00 73 00 65 00 74 00 20 00 74 00 6f 00 20 00 31 00 20 00 2a 00 2a 00}
		$x16 = {5b 00 6d 00 61 00 73 00 74 00 65 00 72 00 6b 00 65 00 79 00 5d 00 20 00 77 00 69 00 74 00 68 00 20 00 44 00 50 00 41 00 50 00 49 00 5f 00 53 00 59 00 53 00 54 00 45 00 4d 00 20 00 28 00 6d 00 61 00 63 00 68 00 69 00 6e 00 65 00 2c 00 20 00 74 00 68 00 65 00 6e 00 20 00 75 00 73 00 65 00 72 00 29 00 3a 00 20 00}

	condition:
		(( uint16( 0 ) == 0x5a4d and 1 of ( $x* ) ) or ( 3 of them ) ) and not pe.imphash ( ) == "77eaeca738dd89410a432c6bd6459907"
}

rule AppInitHook : hardened
{
	meta:
	...
	strings:
		...
		$s1 = {41 70 70 49 6e 69 74 48 6f 6f 6b 2e 64 6c 6c}
		$s2 = {6d 00 69 00 6d 00 69 00 6b 00 61 00 74 00 7a 00 2e 00 65 00 78 00 65 00}
		$s3 = {5d 00 58 00 38 00 36 00 49 00 6e 00 73 00 74 00 72 00 75 00 63 00 74 00 69 00 6f 00 6e 00 2d 00 3e 00 4f 00 70 00 65 00 72 00 61 00 6e 00 64 00 53 00 69 00 7a 00 65 00 20 00 3e 00 3d 00 20 00 4f 00 70 00 65 00 72 00 61 00 6e 00 64 00 2d 00 3e 00 4c 00 65 00 6e 00 67 00 74 00 68 00}
		$s4 = {6d 00 68 00 6f 00 6f 00 6b 00 5c 00 64 00 69 00 73 00 61 00 73 00 6d 00 2d 00 6c 00 69 00 62 00 5c 00 64 00 69 00 73 00 61 00 73 00 6d 00 2e 00 63 00}
		$s5 = {6d 00 68 00 6f 00 6f 00 6b 00 5c 00 64 00 69 00 73 00 61 00 73 00 6d 00 2d 00 6c 00 69 00 62 00 5c 00 64 00 69 00 73 00 61 00 73 00 6d 00 5f 00 78 00 38 00 36 00 2e 00 63 00}
		$s6 = {56 6f 69 64 46 75 6e 63}
