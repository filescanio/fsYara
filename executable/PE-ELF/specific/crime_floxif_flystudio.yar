...
rule MAL_CN_FlyStudio_May18_1 : hardened
{
	meta:
	...
	strings:
		$s1 = {57 54 4e 45 20 2f 20 4d 41 44 45 20 42 59 20 45 20 43 4f 4d 50 49 4c 45 52 20 2d 20 57 55 54 41 4f 20}
		$s2 = {77 77 77 2e 63 66 79 68 61 63 6b 2e 63 6e}
