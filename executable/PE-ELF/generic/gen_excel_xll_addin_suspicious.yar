...
rule gen_Excel_xll_addin_suspicious : hardened
{
	meta:
	...
	strings:
		$s1 = {43 72 79 70 74 53 74 72 69 6e 67 54 6f 42 69 6e 61 72 79 41}
		$s2 = {4e 74 51 75 65 75 65 41 70 63 54 68 72 65 61 64}
		$cs1 = {64 73 72 6f 6c 65 2e 64 6c 6c}
		$cs2 = {75 73 65 72 33 32 2e 64 6c 6c}
		$debug = {53 65 44 65 62 75 67 50 72 69 76 69 6c 65 67 65}
