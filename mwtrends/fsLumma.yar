...
private rule Detect_lumma_stealer : lumma
{
	meta:
...
private rule win_lumma_update_simple_strings_sep_2023
{
	meta:
		author = "Matthew @ Embee_Research"
		created = "2023/09/13"
