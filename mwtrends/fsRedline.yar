...
rule redline_payload : hardened
{
	...
	strings:
		$s1 = {43 61 6d 62 72 65 6c 2e 65 78 65}
...
rule Windows_Trojan_RedLineStealer_17ee6a17 : hardened
{
	meta:
	...
	strings:
		$a1 = {52 65 64 4c 69 6e 65 2e 4c 6f 67 69 63 2e 53 51 4c 69 74 65}
		$a2 = {52 65 64 4c 69 6e 65 2e 52 65 62 75 72 6e 2e 44 61 74 61 2e 42 72 6f 77 73 65 72 73 2e 47 65 63 6b 6f}
		$a3 = {52 65 64 4c 69 6e 65 2e 43 6c 69 65 6e 74 2e 4d 6f 64 65 6c 73 2e 47 65 63 6b 6f}
		$b1 = {53 00 45 00 4c 00 45 00 43 00 54 00 20 00 2a 00 20 00 46 00 52 00 4f 00 4d 00 20 00 57 00 69 00 6e 00 33 00 32 00 5f 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 20 00 57 00 68 00 65 00 72 00 65 00 20 00 53 00 65 00 73 00 73 00 69 00 6f 00 6e 00 49 00 64 00 3d 00 27 00 7b 00 30 00 7d 00 27 00}
		$b2 = {67 65 74 5f 65 6e 63 72 79 70 74 65 64 55 73 65 72 6e 61 6d 65}
		$b3 = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 69 00 63 00 61 00 6e 00 68 00 61 00 7a 00 69 00 70 00 2e 00 63 00 6f 00 6d 00}
		$b4 = {47 65 74 50 72 69 76 61 74 65 33 4b 65 79}
		$b5 = {67 65 74 5f 47 72 61 62 54 65 6c 65 67 72 61 6d}
		$b6 = {3c 47 72 61 62 55 73 65 72 41 67 65 6e 74 3e 6b 5f 5f 42 61 63 6b 69 6e 67 46 69 65 6c 64}

	condition:
		1 of ( $a* ) or all of ( $b* )
}

rule Windows_Trojan_RedLineStealer_f54632eb : hardened
{
	meta:
		author = "Elastic Security"
	...
	strings:
		$a1 = {74 00 74 00 70 00 3a 00 2f 00 2f 00 63 00 68 00 65 00 63 00 6b 00 69 00 70 00 2e 00 61 00 6d 00 61 00 7a 00 6f 00 6e 00 61 00 77 00 73 00 2e 00 63 00 6f 00 6d 00 2f 00 6c 00 6f 00 67 00 69 00 6e 00 73 00 2e 00 6a 00 73 00 6f 00 6e 00}
		$a2 = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 69 00 70 00 69 00 6e 00 66 00 6f 00 2e 00 69 00 6f 00 2f 00 69 00 70 00 25 00 61 00 70 00 70 00 64 00 61 00 74 00 61 00 25 00 5c 00}
		$a3 = {53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 56 00 61 00 6c 00 76 00 65 00 5c 00 53 00 74 00 65 00 61 00 6d 00 4c 00 6f 00 67 00 69 00 6e 00 20 00 44 00 61 00 74 00 61 00}
		$a4 = {67 65 74 5f 53 63 61 6e 6e 65 64 57 61 6c 6c 65 74 73}
		$a5 = {67 65 74 5f 53 63 61 6e 54 65 6c 65 67 72 61 6d}
		$a6 = {67 65 74 5f 53 63 61 6e 47 65 63 6b 6f 42 72 6f 77 73 65 72 73 50 61 74 68 73}
		$a7 = {3c 50 72 6f 63 65 73 73 65 73 3e 6b 5f 5f 42 61 63 6b 69 6e 67 46 69 65 6c 64}
		$a8 = {3c 47 65 74 57 69 6e 64 6f 77 73 56 65 72 73 69 6f 6e 3e 67 5f 5f 48 4b 4c 4d 5f 47 65 74 53 74 72 69 6e 67 7c 31 31 5f 30}
		$a9 = {3c 53 63 61 6e 46 54 50 3e 6b 5f 5f 42 61 63 6b 69 6e 67 46 69 65 6c 64}
		$a10 = {44 61 74 61 4d 61 6e 61 67 65 72 2e 44 61 74 61 2e 43 72 65 64 65 6e 74 69 61 6c 73}

	condition:
		6 of ( $a* )
}

rule Windows_Trojan_RedLineStealer_3d9371fd : hardened
{
	meta:
		author = "Elastic Security"
	...
	strings:
		$a1 = {67 65 74 5f 65 6e 63 72 79 70 74 65 64 5f 6b 65 79}
		$a2 = {67 65 74 5f 50 61 73 73 65 64 50 61 74 68 73}
		$a3 = {43 68 72 6f 6d 65 47 65 74 4c 6f 63 61 6c 4e 61 6d 65}
		$a4 = {47 65 74 42 72 6f 77 73 65 72 73}
		$a5 = {53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 56 00 61 00 6c 00 76 00 65 00 5c 00 53 00 74 00 65 00 61 00 6d 00 4c 00 6f 00 67 00 69 00 6e 00 20 00 44 00 61 00 74 00 61 00}
		$a6 = {25 00 61 00 70 00 70 00 64 00 61 00 74 00 61 00 25 00 5c 00}
		$a7 = {53 63 61 6e 50 61 73 73 77 6f 72 64 73}
...
rule RedLineDropperEXE : hardened
{
	meta:
		author = "ditekSHen"
	...
	strings:
		$s1 = {57 00 69 00 7a 00 75 00 74 00 65 00 7a 00 69 00 6e 00 6f 00 64 00 20 00 74 00 6f 00 67 00 65 00 74 00 6f 00 30 00 52 00 6f 00 77 00 61 00 64 00 75 00 66 00 65 00 76 00 6f 00 6d 00 75 00 6b 00 69 00 20 00 66 00 75 00 74 00 65 00 6e 00 75 00 6a 00 69 00 6c 00 61 00 7a 00 65 00 6d 00 20 00 6a 00 69 00 63 00 20 00 6c 00 65 00 66 00 6f 00 67 00 61 00 74 00 65 00 6e 00 65 00 7a 00 69 00 6e 00 6f 00 72 00}
		$s2 = {36 00 54 00 61 00 74 00 61 00 66 00 61 00 6d 00 6f 00 62 00 65 00 76 00 6f 00 66 00 61 00 6a 00 20 00 62 00 69 00 7a 00 61 00 66 00 6f 00 6a 00 75 00 20 00 70 00 65 00 79 00 6f 00 76 00 61 00 76 00 61 00 63 00 6f 00 63 00 6f 00 20 00 6c 00 69 00 7a 00 69 00 6e 00 65 00 20 00 6b 00 65 00 7a 00 61 00 6b 00 61 00 6a 00 75 00 6a 00}
		$s3 = {4c 00 61 00 77 00 75 00 68 00 65 00 72 00 75 00 73 00 6f 00 7a 00 65 00 72 00 75 00 20 00 6b 00 75 00 63 00 75 00 20 00 7a 00 61 00 6d 00 30 00 5a 00 6f 00 72 00 69 00 7a 00 65 00 79 00 75 00 6b 00 20 00 6c 00 65 00 70 00 61 00 70 00 6f 00 73 00 75 00 70 00 75 00 20 00 67 00 61 00 6c 00 61 00 20 00 6b 00 69 00 6e 00 61 00 72 00 75 00 73 00 6f 00 74 00 20 00 72 00 75 00 76 00 61 00 73 00 61 00 78 00 65 00 68 00 75 00 77 00 6f 00}
		$s4 = {43 6c 65 61 72 45 76 65 6e 74 4c 6f 67 57}
		$s5 = {50 00 72 00 6f 00 64 00 75 00 63 00 74 00 69 00 6f 00 6e 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00}
...
rule RedLine_1 : hardened limited
{
	...
	strings:
		...
		$s4 = {42 00 7c 00 42 00 78 00 42 00 74 00 42 00 70 00 42 00 6c 00 42 00 68 00 42 00 64 00 42 00 60 00 42 00 5c 00 42 00 58 00 42 00 54 00 42 00 50 00 42 00 4c 00 42 00 48 00 42 00 44 00 42 00 40 00 42 00 3c 00 42 00 38 00 42 00 34 00 42 00 30 00 42 00 2c 00 42 00 28 00 42 00 24 00 42 00 20 00 42 00}
		$s5 = {20 64 65 6c 65 74 65 5b 5d}
		...
		$x3 = {68 00 6f 00 73 00 74 00 49 00 52 00 65 00 6d 00 6f 00 74 00 65 00 50 00 61 00 6e 00 65 00 6c 00 2c 00 20 00 43 00 6f 00 6d 00 6d 00 61 00 6e 00 64 00 4c 00 69 00 6e 00 65 00 3a 00 20 00}
		...
		$u5 = {46 69 6e 67 65 72 50 72 69 6e 74 54}
		$u6 = {49 6e 73 74 61 6c 6c 65 64 42 72 6f 77 73 65 72 49 6e 66 6f 54}
		$u7 = {52 75 6e 50 45}
		$u8 = {44 6f 77 6e 6c 6f 61 64 41 6e 64 45 78}
		...
		$pat1 = {28 00 28 00 28 00 28 00 5b 00 30 00 2d 00 39 00 2e 00 5d 00 29 00 5c 00 64 00 29 00 2b 00 29 00 7b 00 31 00 7d 00 29 00}
		$pat2 = {5e 00 28 00 3f 00 3a 00 32 00 31 00 33 00 31 00 7c 00 31 00 38 00 30 00 30 00 7c 00 33 00 35 00 5c 00 5c 00 64 00 7b 00 33 00 7d 00 29 00 5c 00 5c 00 64 00 7b 00 31 00 31 00 7d 00 24 00}
		$pat3 = {36 00 28 00 3f 00 3a 00 30 00 31 00 31 00 7c 00 35 00 5b 00 30 00 2d 00 39 00 5d 00 7b 00 32 00 7d 00 29 00 5b 00 30 00 2d 00 39 00 5d 00 7b 00 31 00 32 00 7d 00 24 00 2f 00 43 00}
		$pat4 = {54 00 65 00 6c 00 65 00 67 00 72 00 61 00 6d 00 70 00 72 00 6f 00 66 00 69 00 6c 00 65 00 73 00 5e 00 28 00 36 00 33 00 30 00 34 00 7c 00 36 00 37 00 30 00 36 00 7c 00 36 00 37 00 30 00 39 00 7c 00 36 00 37 00 37 00 31 00 29 00 5b 00 30 00 2d 00 39 00 5d 00 7b 00 31 00 32 00 2c 00 31 00 35 00 7d 00 24 00}
		$pat5 = {68 00 6f 00 73 00 74 00 5f 00 6b 00 65 00 79 00 5e 00 28 00 3f 00 3a 00 34 00 5b 00 30 00 2d 00 39 00 5d 00 7b 00 31 00 32 00 7d 00 28 00 3f 00 3a 00 5b 00 30 00 2d 00 39 00 5d 00 7b 00 33 00 7d 00 29 00 3f 00 7c 00 35 00 5b 00 31 00 2d 00 35 00 5d 00 5b 00 30 00 2d 00 39 00 5d 00 7b 00 31 00 34 00 7d 00 29 00 24 00}
		...
		$v2_1 = {4c 69 73 74 4f 66 50 72 6f 63 65 73 73 65 73}
		...
		$v2_3 = {47 65 74 41 72 67 75 6d 65 6e 74 73}
		$v2_4 = {56 65 72 69 66 79 55 70 64 61 74 65}
		$v2_5 = {56 65 72 69 66 79 53 63 61 6e 52 65 71 75 65 73 74}
		$v2_6 = {47 65 74 55 70 64 61 74 65 73}
		$v3_1 = {6c 6f 63 61 6c 68 6f 73 74 2e 49 55 73 65 72 53 65 72 76 69 63 65 75}
		$v3_2 = {50 61 72 73 65 4e 65 74 77 6f 72 6b 49 6e 74 65 72 66 61 63 65 73}
		$v3_3 = {52 65 70 6c 79 41 63 74 69 6f 6e 30 68 74 74 70 3a 2f 2f 74 65 6d 70 75 72 69 2e 6f 72 67 2f 49 55 73 65 72 53 65 72 76 69 63 65 2f 47 65 74 55 73 65 72 73 52 65 73 70 6f 6e 73 65}
		$v3_4 = {41 63 74 69 6f 6e 28 68 74 74 70 3a 2f 2f 74 65 6d 70 75 72 69 2e 6f 72 67 2f 49 55 73 65 72 53 65 72 76 69 63 65 2f 47 65 74 55 73 65 72 73 54}
		$v3_5 = {62 00 61 00 73 00 69 00 63 00 43 00 66 00 67 00}
		$vx4_1 = {43 00 3a 00 5c 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 2e 00 4e 00 45 00 54 00 5c 00 5c 00 46 00 72 00 61 00 6d 00 65 00 77 00 6f 00 72 00 6b 00 5c 00 5c 00 76 00 34 00 2e 00 30 00 2e 00 33 00 30 00 33 00 31 00 39 00 5c 00 5c 00 41 00 64 00 64 00 49 00 6e 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 33 00 32 00 2e 00 65 00 78 00 65 00}
		$v4_2 = {69 73 57 6f 77 36 34}
		$v4_3 = {62 61 73 65 36 34 73 74 72}
		$v4_4 = {73 74 72 69 6e 67 4b 65 79}
		$v4_5 = {42 79 74 65 73 54 6f 53 74 72 69 6e 67 43 6f 6e 76 65 72 74 65 64}
		$v4_6 = {46 72 6f 6d 42 61 73 65 36 34}
		$v4_7 = {78 6f 72 65 64 53 74 72 69 6e 67}
		$v4_8 = {70 72 6f 63 4e 61 6d 65}
		$v4_9 = {62 61 73 65 36 34 45 6e 63 6f 64 65 64 44 61 74 61}
		$v5_1 = {44 6f 77 6e 6c 6f 61 64 41 6e 64 45 78 65 63 75 74 65 55 70 64 61 74 65}
		$v5_2 = {49 54 61 73 6b 50 72 6f 63 65 73 73 6f 72}
		$v5_3 = {43 6f 6d 6d 61 6e 64 4c 69 6e 65 55 70 64 61 74 65}
		$v5_4 = {44 6f 77 6e 6c 6f 61 64 55 70 64 61 74 65}
		$v5_5 = {46 69 6c 65 53 63 61 6e 6e 69 6e 67}
		$v5_6 = {47 65 74 4c 65 6e 54 6f 50 6f 73 53 74 61 74 65}
		$v5_7 = {52 65 63 6f 72 64 48 65 61 64 65 72 46 69 65 6c 64}
		$v5_8 = {45 6e 64 70 6f 69 6e 74 43 6f 6e 6e 65 63 74 69 6f 6e}
		$v5_9 = {42 43 52 59 50 54 5f 4b 45 59 5f 4c 45 4e 47 54 48 53 5f 53 54 52 55 43 54}
		$v6_1 = {25 00 6c 00 6f 00 63 00 61 00 6c 00 61 00 70 00 70 00 64 00 61 00 74 00 61 00 25 00 5c 00}
		$v6_2 = {47 65 74 44 65 63 6f 64 65 64}
		$v6_3 = {2f 00 2f 00 73 00 65 00 74 00 74 00 69 00 6e 00 53 00 74 00 72 00 69 00 6e 00 67 00 2e 00 52 00 65 00 6d 00 6f 00 76 00 65 00 67 00 5b 00 40 00 6e 00 61 00 6d 00 65 00 3d 00 5c 00 50 00 61 00 73 00 73 00 77 00 53 00 74 00 72 00 69 00 6e 00 67 00 2e 00 52 00 65 00 6d 00 6f 00 76 00 65 00 6f 00 72 00 64 00 5c 00 5d 00 2f 00 76 00 61 00 6c 00 75 00 53 00 74 00 72 00 69 00 6e 00 67 00 2e 00 52 00 65 00 6d 00 6f 00 76 00 65 00 65 00 52 00 4f 00 4f 00 54 00 5c 00 53 00 65 00 63 00 75 00 72 00 69 00 74 00 79 00 43 00 65 00 6e 00 74 00 65 00 72 00}
		...
		$v6_5 = {3c 47 65 74 57 69 6e 64 6f 77 73 56 65 72 73 69 6f 6e 3e 67 5f 5f 48 4b 4c 4d 5f 47 65 74 53 74 72 69 6e 67 7c 31 31 5f 30}
		$v6_6 = {6e 00 65 00 74 00 2e 00 74 00 63 00 70 00 3a 00 2f 00 2f 00}
...
rule Mal_Stealer_NET_Redline_Aug_2020_1 : hardened
{
	meta:
	...
	strings:
		...
		$s6 = {3c 65 6e 63 72 79 70 74 65 64 5f 6b 65 79 3e 6b 5f 5f 42 61 63 6b 69 6e 67 46 69 65 6c 64}
		$s7 = {73 65 74 5f 65 6e 63 72 79 70 74 65 64 5f 6b 65 79}
		$s8 = {55 73 65 72 41 67 65 6e 74 44 65 74 65 63 74 6f 72}
		$s9 = {73 65 74 5f 65 6e 63 72 79 70 74 65 64 5f 6b 65 79}
		$s10 = {73 65 74 5f 46 74 70 43 6f 6e 6e 65 63 74 69 6f 6e 73}
		$s11 = {73 65 74 5f 49 73 50 72 6f 63 65 73 73 45 6c 65 76 61 74 65 64}
		$s12 = {53 00 45 00 4c 00 45 00 43 00 54 00 20 00 45 00 78 00 65 00 63 00 75 00 74 00 61 00 62 00 6c 00 65 00 50 00 61 00 74 00 68 00 2c 00 20 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 49 00 44 00 20 00 46 00 52 00 4f 00 4d 00 20 00 57 00 69 00 6e 00 33 00 32 00 5f 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00}
		$s13 = {3c 49 73 50 72 6f 63 65 73 73 45 6c 65 76 61 74 65 64 3e 6b 5f 5f 42 61 63 6b 69 6e 67 46 69 65 6c 64}
		$s14 = {53 79 73 74 65 6d 2e 43 6f 6c 6c 65 63 74 69 6f 6e 73 2e 47 65 6e 65 72 69 63 2e 49 45 6e 75 6d 65 72 61 62 6c 65 3c 52 65 64 4c 69 6e 65 2e 4c 6f 67 69 63 2e 4a 73 6f 6e 2e 4a 73 6f 6e 56 61 6c 75 65 3e 2e 47 65 74 45 6e 75 6d 65 72 61 74 6f 72}
		$s15 = {53 79 73 74 65 6d 2e 43 6f 6c 6c 65 63 74 69 6f 6e 73 2e 47 65 6e 65 72 69 63 2e 49 45 6e 75 6d 65 72 61 74 6f 72 3c 52 65 64 4c 69 6e 65 2e 4c 6f 67 69 63 2e 4a 73 6f 6e 2e 4a 73 6f 6e 56 61 6c 75 65 3e 2e 67 65 74 5f 43 75 72 72 65 6e 74}
		$s16 = {48 00 4b 00 45 00 59 00 5f 00 43 00 55 00 52 00 52 00 45 00 4e 00 54 00 5f 00 55 00 53 00 45 00 52 00 5c 00 53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 43 00 75 00 72 00 72 00 65 00 6e 00 74 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 5c 00 41 00 70 00 70 00 20 00 50 00 61 00 74 00 68 00 73 00 5c 00 62 00 72 00 6f 00 77 00 73 00 65 00 72 00 2e 00 65 00 78 00 65 00}
		$s17 = {50 72 6f 63 65 73 73 45 78 65 63 75 74 61 62 6c 65 50 61 74 68}
		$s18 = {49 73 50 72 6f 63 65 73 73 45 6c 65 76 61 74 65 64}
		$s19 = {48 00 4b 00 45 00 59 00 5f 00 43 00 55 00 52 00 52 00 45 00 4e 00 54 00 5f 00 55 00 53 00 45 00 52 00 5c 00 53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 43 00 75 00 72 00 72 00 65 00 6e 00 74 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 5c 00 41 00 70 00 70 00 20 00 50 00 61 00 74 00 68 00 73 00 5c 00 66 00 69 00 72 00 65 00 66 00 6f 00 78 00 2e 00 65 00 78 00 65 00}
		$s20 = {67 65 74 5f 65 6e 63 72 79 70 74 65 64 50 61 73 73 77 6f 72 64}
